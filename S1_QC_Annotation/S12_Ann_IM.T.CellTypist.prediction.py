...
projectName="ThymomaT"

SaveFolder="./Thymus/h5ad"
tempOut="./Thymus/h5ad"


adata=scvi.data.read_h5ad("./Thymus/h5ad/ThymomaT.h5ad")
adataOut = adata
...
##################################################################
##################################################################
nuDataIn=scvi.data.read_h5ad("./Thymus/h5ad/NUThymusT.h5ad")
sc.pp.pca(nuDataIn, n_comps=50)

ct_predictions = celltypist.annotate(nuDataIn, 
...
nuData.write(f"{SaveFolder}/{projectName}_Tcells.h5ad")
nuData.obs.to_csv(f"{SaveFolder}/{projectName}_Tcells_predictFromCellTypise.csv")
