...
CT=pd.read_csv("./Projects/ManuscriptData/IntegrateThymus/data/RDS/thymus_meta.csv",index_col='ID')
adata2=adata.copy()
adata2.obs = adata2.obs.merge(CT, left_index=True, right_index=True, how='left')
adata.obs.index.equals(adata2.obs.index)

adata2.write(f"{SaveFolder}/{projectName}_AddCT.h5ad")
