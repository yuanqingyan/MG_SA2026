...
projectName="Thymus_Manu_bulk_SubB"
...
adata=scvi.data.read_h5ad("./Thymus/FigOut/forPseudoBulk_Bcell.h5ad")
adata
...
savePath=f"{SaveFolder}/PseudoBulk/SubBcell"
CUTOFF = 25
for i in meta.Bsub.unique():
    ct=i
    cells = meta.index[meta.Bsub == ct] 
